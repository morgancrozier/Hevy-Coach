...
class EmailSender:
    ...
    def send_report(self, report_content: str, markdown_file: str = None) -> bool:
        ...
        try:
            ...
            # Extract key metrics from the report for a clean email summary
            ...
            for line in lines:
                if "Overall Grade" in line and ":" in line:
                    overall_grade = line.split(":", 1)[1].strip()
                elif "Assessment" in line and ":" in line:
                    assessment = line.split(":", 1)[1].strip()
                elif "Progression" in line and "progressed" in line:
                    progression_summary = line.split(":", 1)[1].strip()
            
            # Create a clean, well-formatted email body
            email_body = f"""🏋️‍♂️ Your Daily Hevy Coaching Report is Ready!

📊 TODAY'S SESSION QUALITY:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🎯 Overall Grade: {overall_grade}
📝 Assessment: {assessment}
💪 Progress: {progression_summary}

📎 FULL DETAILED ANALYSIS:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
• Complete progression analysis across all exercises
• RPE-based coaching recommendations  
• Historical decision analysis and learning insights
• Next session weight recommendations
• Volume trends and recovery insights

📄 The complete report is attached as a markdown file.

💡 ABOUT THIS REPORT:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
This automated analysis uses your Hevy workout data to provide:
✓ Intelligent RPE-based progression recommendations
✓ Session quality scoring with A+ to D grades  
✓ Smart detection of good vs. problematic weight changes
✓ Historical pattern analysis to optimize future sessions

🚀 Keep up the great work! Your fitness journey is being tracked
   and optimized with every session.

───────────────────────────────────────────────────────────────
Generated by Hevy Coach Pro | {datetime.now().strftime('%Y-%m-%d %H:%M UTC')}
            """
            
            msg.attach(MIMEText(email_body, 'plain'))
            
            # Attach markdown file if provided
