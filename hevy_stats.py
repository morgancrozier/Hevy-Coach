...
class EmailSender:
    ...
    def send_report(self, report_content: str, markdown_file: str = None) -> bool:
        ...
        try:
            ...
            # Email body (truncated version for readability)
            lines = report_content.split('\n')
            summary_lines = []
            in_summary = False
            
            for line in lines:
                if "SESSION QUALITY ASSESSMENT" in line:
                    in_summary = True
                elif "EXERCISE PROGRESSION ANALYSIS" in line:
                    break
            ...
            email_body = f"""
🏋️‍♂️ Your Daily Hevy Coaching Report is ready!

{''.join(summary_lines[:20])}

📎 Full detailed report is attached as a markdown file.

💡 This automated report analyzes your workout progression, RPE patterns, and provides personalized coaching recommendations.
